...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            <h1 class="h5 m-0 text-gray-800 font-weight-bold">Detail Pemesanan</h1>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-row justify-content-between">
                        ...
                        @if (auth()->user()->level == 2 && $status != 'disetujui')
                            <div class="form-group col-4">
                                <label for="name" class="form-label">Aksi</label>
                                <div class="d-flex">
                                    <form action="/admin/orders/{{$order}}" method="POST" class="mr-2">
                                        @method('PUT')
                                        @csrf
